...
const SportsScience = () => {
  ...
  const specializations = [
    {
      ...
      icon: <DirectionsRun />,
      description: 'Athletic training, performance analysis, and coaching',
    },
    {
      title: 'Sports Medicine',
      icon: <LocalHospital />,
      description: 'Injury prevention, rehabilitation, and sports therapy',
    },
    {
      title: 'Sports Psychology',
      icon: <Psychology />,
      description: 'Mental training, motivation, and performance psychology',
    },
    {
      title: 'Fitness Training',
      icon: <FitnessCenter />,
      description: 'Strength conditioning, nutrition, and fitness programming',
    },
  ];
  ...
  const outcomes = [
    'Understand human movement and performance',
    'Design effective training programs',
    'Apply sports science principles',
